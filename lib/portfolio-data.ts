...
export const education: Education[] = [
  ...
  },
  {
    ...
    year: '2022 - 2023',
    details: ['Completed Higher Secondary Certificate coursework.', 'Focused on Physics, Chemistry, and Mathematics.'],
  },
];
...
export const projects: Project[] = [
  {
    ...
    description: 'My own AI-powered operations platform for scheduling, monitoring, workflow automation, and execution intelligence.',
  ...
  },
  {
    ...
    description: 'Resume analysis tool that reads candidate documents and suggests practical improvements using AI/NLP concepts.',
  ...
  },
  {
    ...
    description: 'Deep learning system for skin disease classification, built as a medical AI experiment with CNN-based detection.',
